...
echo -e $YELLOW"Please, use it at your own risk."$ENDCOLOR
sleep 5
clear
...
# Run keychain-dumper to get credentials.
...
echo -e $YELLOW"Please, set username : "$ENDCOLOR
read username
echo
echo -e $YELLOW"Please, set IP address :"$ENDCOLOR
read IP
echo
